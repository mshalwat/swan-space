<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('admin.services.create') }}" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg">
                Add New Service
            </a>
        </div>
    </x-slot>
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead>
                            <tr>
                                ...
                                <th class="px-6 py-3 bg-gray-50 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Title (EN)</th>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @foreach($services as $service)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">{{ $service->title_en }}</td>
