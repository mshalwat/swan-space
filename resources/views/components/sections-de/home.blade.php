...
<head>
    ...
    <title>SwanSpace - Digitale Lösungen für moderne Bildung</title>
    <meta name="description" content="SwanSpace transformiert Bildungseinrichtungen mit innovativen Web-Lösungen.">
                ...
                <div class="container-custom">
                    <div class="flex items-center justify-between h-20">
                        ...
                        <div class="hidden lg:flex items-center gap-8">
                            <a href="#home" class="text-gray-300 hover:text-transparent hover:bg-clip-text hover:bg-gradient-to-r hover:from-purple-400 hover:to-pink-400 transition-all duration-300 relative group">Startseite<span class="absolute -bottom-1 left-0 w-0 h-0.5 bg-gradient-to-r from-purple-500 to-pink-500 group-hover:w-full transition-all duration-300"></span></a>
                            <a href="#services" class="text-gray-300 hover:text-transparent hover:bg-clip-text hover:bg-gradient-to-r hover:from-purple-400 hover:to-pink-400 transition-all duration-300 relative group">Dienstleistungen<span class="absolute -bottom-1 left-0 w-0 h-0.5 bg-gradient-to-r from-purple-500 to-pink-500 group-hover:w-full transition-all duration-300"></span></a>
                            <a href="#about" class="text-gray-300 hover:text-transparent hover:bg-clip-text hover:bg-gradient-to-r hover:from-purple-400 hover:to-pink-400 transition-all duration-300 relative group">Über uns<span class="absolute -bottom-1 left-0 w-0 h-0.5 bg-gradient-to-r from-purple-500 to-pink-500 group-hover:w-full transition-all duration-300"></span></a>
                            <a href="#contact" class="text-gray-300 hover:text-transparent hover:bg-clip-text hover:bg-gradient-to-r hover:from-purple-400 hover:to-pink-400 transition-all duration-300 relative group">Kontakt<span class="absolute -bottom-1 left-0 w-0 h-0.5 bg-gradient-to-r from-purple-500 to-pink-500 group-hover:w-full transition-all duration-300"></span></a>
                        </div>
                        ...
                        <div class="hidden lg:flex items-center gap-4">
                            ...
                            <div class="relative" x-data="{ open: false }">
                                ...
                                <div x-show="open"
                                     ...
                                     style="display: none;">
                                    <a href="{{ route('home.en') }}" class="block px-4 py-3 text-sm text-gray-300 hover:bg-purple-600/30 hover:text-white transition-colors border-b border-purple-500/20">
                                    ...
                                    <a href="{{ route('home.de') }}" class="block px-4 py-3 text-sm text-white bg-purple-600/30 hover:bg-purple-600/50 transition-colors">
                                        <div class="flex items-center gap-2">
                            ...
                            <a href="#contact" class="relative overflow-hidden group bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white rounded-full px-6 py-3 shadow-lg hover:shadow-purple-500/50 transition-all duration-300 transform hover:scale-105 z-10">
                                <span class="relative z-10 font-semibold">Jetzt Starten</span>
                            </a>
                        </div>
                    ...
                    <div id="mobile-menu" class="hidden lg:hidden pb-4">
                        <div class="flex flex-col space-y-4 mt-4">
                            <a href="#home" class="text-gray-300 hover:text-purple-400 transition-colors px-4 py-2 rounded-lg hover:bg-purple-600/20">Startseite</a>
                            <a href="#services" class="text-gray-300 hover:text-purple-400 transition-colors px-4 py-2 rounded-lg hover:bg-purple-600/20">Dienstleistungen</a>
                            <a href="#about" class="text-gray-300 hover:text-purple-400 transition-colors px-4 py-2 rounded-lg hover:bg-purple-600/20">Über uns</a>
                            <a href="#contact" class="text-gray-300 hover:text-purple-400 transition-colors px-4 py-2 rounded-lg hover:bg-purple-600/20">Kontakt</a>
                            <div class="border-t border-purple-500/20 pt-4">
                                <div class="text-gray-400 text-sm px-4 mb-2">Sprache</div>
                                <a href="{{ route('home.en') }}" class="block text-gray-300 hover:text-purple-400 hover:bg-purple-600/20 transition-colors px-4 py-2 rounded-lg">English</a>
                                <a href="{{ route('home.de') }}" class="block text-white bg-purple-600/30 hover:bg-purple-600/50 transition-colors px-4 py-2 rounded-lg mt-2">Deutsch</a>
                            </div>
                            <a href="#contact" class="bg-gradient-to-r from-purple-600 to-pink-600 text-white text-center rounded-full px-6 py-3 shadow-lg hover:shadow-purple-500/50 transition-all duration-300 font-semibold">Jetzt Starten</a>
                        </div>
                    </div>
                </div>
            </nav>
            ...
            <div class="space-y-8">
                <div class="inline-flex items-center gap-2 px-4 py-2 bg-[#1a1f3a]/60 backdrop-blur-md rounded-full border border-purple-500/30 glow-effect">
                    ...
                    <span class="text-sm text-gray-300">
                        {{ $heroContent['badge'] ?? 'Digitale Innovation für Bildung' }}
                    </span>
                </div>

                <div class="space-y-4">
                    <h1 class="text-5xl lg:text-7xl">
                        {{ $heroContent['title'] ?? 'Verwandeln Sie Ihre Schule in ein' }}
                        <span class="text-gradient-nebula animate-pulse">
                            {{ $heroContent['title_highlight'] ?? 'Digitales Universum' }}
                        </span>
                    </h1>
                </div>

                <p class="text-xl text-gray-300 leading-relaxed">
                    {{ $heroContent['description'] ?? 'Erleben Sie modernste digitale Lösungen speziell für moderne Bildungseinrichtungen. Wir bringen Innovation in jedes Klassenzimmer.' }}
                </p>
                ...
                <div class="flex flex-col sm:flex-row gap-4">
                    <a href="#contact" class="group relative overflow-hidden px-8 py-4 bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-full transition-all duration-300 flex items-center justify-center gap-2 hover:shadow-2xl hover:shadow-purple-500/50 hover:scale-105">
                        <span class="relative z-10">Jetzt Starten</span>
                        ...
                        <div class="absolute inset-0 glass-card-dark rounded-3xl p-8 shadow-3d-lg card-stack-front overflow-hidden">
                            ...
                            <div class="relative h-full flex flex-col items-center justify-center space-y-8 z-10">
                                ...
                                <div class="text-center space-y-4">
                                    <h3 class="text-2xl font-heading font-bold text-gradient-nebula">Moderne Schulplattform</h3>
                                    <p class="text-gray-400">Angetrieben von modernster Technologie</p>
                                </div>
        ...
        <div class="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div class="space-y-6 order-1 lg:order-2">
                <div class="inline-block px-4 py-2 bg-[#1a1f3a]/60 backdrop-blur-md rounded-full border border-purple-500/30">
                    <span class="text-sm text-gray-300">{{ $aboutContent['badge'] ?? 'Über SwanSpace' }}</span>
                </div>

                <h2>
                    {{ $aboutContent['title'] ?? 'Innovation trifft' }}
                    <span class="text-gradient-cosmic">
                        {{ $aboutContent['title_highlight'] ?? 'Bildung' }}
                    </span>
                </h2>

                <p class="text-xl text-gray-300 leading-relaxed">
                    {{ $aboutContent['description'] ?? 'Wir sind Pioniere in der digitalen Transformation für Bildungseinrichtungen und verbinden modernste Technologie mit tiefem Verständnis für moderne Lernumgebungen.' }}
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="container-custom">
        <div class="text-center mb-16">
            <div class="inline-block px-4 py-2 bg-[#1a1f3a]/60 backdrop-blur-md rounded-full border border-purple-500/30 mb-6">
                <span class="text-sm text-gray-300">{{ $servicesContent['badge'] ?? 'Unsere Dienstleistungen' }}</span>
            </div>
            <h2 class="mb-6">
                {{ $servicesContent['title'] ?? 'Umfassende Digitale' }}
                <span class="text-gradient-nebula">
                    {{ $servicesContent['title_highlight'] ?? 'Lösungen' }}
                </span>
            </h2>
            <p class="text-xl text-gray-300 max-w-3xl mx-auto">
                {{ $servicesContent['description'] ?? 'Von maßgeschneiderter Entwicklung bis hin zu kompletten digitalen Ökosystemen bieten wir alles, was Ihre Institution braucht, um im digitalen Zeitalter erfolgreich zu sein.' }}
            </p>
        </div>
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            @foreach($services ?? [] as $service)
                <div class="group relative">
                    <div class="glass-card-dark rounded-2xl p-8 h-full transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-purple-500/20">
                        <!-- Icon -->
...
<section id="testimonials" class="py-20 relative">
    <div class="container-custom">
        <div class="text-center mb-16">
            <div class="inline-block px-4 py-2 bg-[#1a1f3a]/60 backdrop-blur-md rounded-full border border-purple-500/30 mb-6">
                <span class="text-sm text-gray-300">Erfahrungsberichte</span>
            </div>
            <h2 class="mb-6">
                Vertraut von
                <span class="text-gradient-cosmic">Bildungsführern</span>
            </h2>
        </div>

        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            @foreach($testimonials ?? [] as $testimonial)
                <div class="glass-card-dark rounded-2xl p-8 hover:scale-105 transition-all duration-300">
                    <!-- Rating Stars -->
...
<section id="contact" class="py-20 relative">
    <div class="container-custom">
        <div class="text-center mb-16">
            <div class="inline-block px-4 py-2 bg-[#1a1f3a]/60 backdrop-blur-md rounded-full border border-purple-500/30 mb-6">
                <span class="text-sm text-gray-300">Kontakt aufnehmen</span>
            </div>
            <h2 class="mb-6">
                Beginnen Sie Ihre
                <span class="text-gradient-cosmic">Digitale Reise</span>
            </h2>
        </div>

        <div class="max-w-2xl mx-auto">
            <div class="glass-card-dark rounded-3xl p-8 lg:p-12">
                <form action="{{ route('contact.submit') }}" method="POST" class="space-y-6">
                    @csrf

                    <div>
                        <label class="block text-gray-300 mb-2">Ihr Name</label>
                        <input type="text" name="name" required class="w-full px-4 py-3 rounded-lg bg-[#1a1f3a]/60 border border-purple-500/30 focus:border-purple-500 text-white placeholder-gray-500 outline-none transition-colors" placeholder="Ihr Name">
                    </div>

                    <div>
                        <label class="block text-gray-300 mb-2">E-Mail-Adresse</label>
                        <input type="email" name="email" required class="w-full px-4 py-3 rounded-lg bg-[#1a1f3a]/60 border border-purple-500/30 focus:border-purple-500 text-white placeholder-gray-500 outline-none transition-colors" placeholder="E-Mail-Adresse">
                    </div>

                    <div>
                        <label class="block text-gray-300 mb-2">Schulname (Optional)</label>
                        <input type="text" name="school" class="w-full px-4 py-3 rounded-lg bg-[#1a1f3a]/60 border border-purple-500/30 focus:border-purple-500 text-white placeholder-gray-500 outline-none transition-colors" placeholder="Schulname">
                    </div>

                    <div>
                        <label class="block text-gray-300 mb-2">Ihre Nachricht</label>
                        <textarea name="message" required rows="5" class="w-full px-4 py-3 rounded-lg bg-[#1a1f3a]/60 border border-purple-500/30 focus:border-purple-500 text-white placeholder-gray-500 outline-none transition-colors resize-none" placeholder="Erzählen Sie uns von Ihrem Projekt..."></textarea>
                    </div>

                    <button type="submit" class="w-full px-8 py-4 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white font-semibold rounded-full transition-all duration-300 shadow-lg hover:shadow-purple-500/50 transform hover:scale-105 relative z-10 cursor-pointer">
            ...
            <!-- Footer -->
            <footer class="relative border-t border-purple-500/20 bg-[#0a0e27]/90 backdrop-blur-xl">
                <div class="container-custom py-16">
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
                        <div>
                            ...
                            <p class="text-gray-400 mb-6">Bildung durch innovative digitale Lösungen transformieren</p>
                            <div class="flex gap-4">
                        ...
                        <div>
                            <h6 class="mb-4 text-white font-semibold">Schnelllinks</h6>
                            <ul class="space-y-3">
                                <li><a href="#home" class="text-gray-400 hover:text-purple-400 transition-colors">Startseite</a></li>
                                <li><a href="#services" class="text-gray-400 hover:text-purple-400 transition-colors">Dienstleistungen</a></li>
                                <li><a href="#about" class="text-gray-400 hover:text-purple-400 transition-colors">Über uns</a></li>
                                <li><a href="#contact" class="text-gray-400 hover:text-purple-400 transition-colors">Kontakt</a></li>
                            </ul>
                        </div>
                        <div>
                            <h6 class="mb-4 text-white font-semibold">Dienstleistungen</h6>
                            <ul class="space-y-3">
                                <li class="text-gray-400 text-sm">Webentwicklung</li>
                                <li class="text-gray-400 text-sm">Mobile Design</li>
                                <li class="text-gray-400 text-sm">Managementsysteme</li>
                            </ul>
                        </div>
                        <div>
                            <h6 class="mb-4 text-white font-semibold">Kontakt</h6>
                            <ul class="space-y-3">
                    ...
                    <div class="border-t border-purple-500/20 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
                        <p class="text-gray-400 text-sm text-center">&copy; {{ date('Y') }} SwanSpace. Alle Rechte vorbehalten.</p>
                        <div class="flex gap-6 text-sm">
                            <a href="#" class="text-gray-400 hover:text-purple-400 transition-colors">Datenschutz</a>
                            <a href="#" class="text-gray-400 hover:text-purple-400 transition-colors">Nutzungsbedingungen</a>
                        </div>
                    </div>
                </div>
            </footer>
